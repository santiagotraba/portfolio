...
function Navbar() {
  return (
    <nav className="px-8 py-6 flex justify-end items-center">
      <ul className="flex gap-4 text-white items-center">
        <li>
          <a href="https://github.com/santiagotraba" target="_blank">
            <svg
        ...
        <li>
          <a href="https://www.linkedin.com/in/santiagotraba/" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              width={24}
